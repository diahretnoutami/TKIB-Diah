    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="card shadow">
                <div class="card-body">
                    <h2 class="text-success">Ubah Data Orang Tua</h2>
                    <form action="{{ route('ortu.update', $data->id_ortu) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label>Nama Orang Tua</label>
                            <input type="text" name="namaortu" class="form-control" value="{{ $data->namaortu }}">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="{{ route('ortu.index') }}" class="btn btn-secondary mt-3">Kembali</a>
                    </form>
                </div>
