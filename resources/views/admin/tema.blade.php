@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid pt-7">
            <h1 class="text-success" style="margin-top: -100px; margin-bottom: 20px;">Halaman Tema Pembelajaran</h1>
            <div class="card shadow">
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="{{ route('tema.create') }}" class="btn btn-success mb-3">
                                ...
                                @foreach ($data as $index => $row)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{ route('tema.edit', $row->id_t) }}"
                                                class="btn btn-info btn-sm">Edit</a>
                                            <form action="{{ route('tema.destroy', $row->id_t) }}" method="POST"
        ...
        <script>
            $(document).ready(function() {
                ...
                autoWidth: false 
                }); // <--- ini bikin search & pagination aktif
            });
        </script>
