                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; font-size: 16px;">Dokumentasi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($uniqueCps as $index => $cp)
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; word-break: break-word; white-space: normal; overflow-wrap: break-word; max-width: 80px;">{{ $materi }}</td>
                                        <td style="text-align: left; word-break: break-word; white-space: normal; overflow-wrap: break-word; max-width: 80px;">
